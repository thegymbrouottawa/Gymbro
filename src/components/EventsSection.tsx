  ...
  const events: Event[] = [
    {
      ...
      description:
        "The GymBro club is honored to receive the Sports Club of the Year award at the annual Student Life Awards ceremony.",
      type: "award",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-1 h-full">
            ...
            <CardContent className="p-6 bg-black text-white">
              <div className="flex items-center mb-3">
                ...
                <Badge
                  variant="outline"
                  className="border-gymbro-orange text-gymbro-orange"
                >
                  Award
                </Badge>
              </div>
              <h3 className="text-xl font-bold mb-2 text-gymbro-orange">
                Students Life Award 2025
              </h3>
              <p className="text-gray-300 text-sm mb-4">
                Sports Club of the Year Award received by The GymBro at the
                annual Student Life Awards ceremony.
              </p>
        ...
        <Card className="col-span-full lg:col-span-2 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
            ...
            <CardContent className="p-6 bg-black text-white flex flex-col justify-center">
              <h3 className="text-2xl font-bold mb-4 text-gymbro-orange">
                Team Achievement
              </h3>
              <p className="text-gray-300 mb-6">
                The GymBro team celebrates their achievement at the Student Life
                Awards 2025. Hard work and dedication from all our members led
                to this recognition.
              </p>
              <p className="text-gymbro-orange font-semibold">
                We're proud of our community and thankful for everyone's
                support!
              </p>
            </CardContent>
          </div>
