            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-gymbro-darkGray rounded-lg overflow-hidden shadow-lg border border-gray-800">
                ...
                <div className="p-4">
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button variant="ghost" className="text-gymbro-orange hover:text-white p-0">
                    ...
                    <DialogContent className="bg-gymbro-darkGray text-white border border-gray-800 max-w-3xl max-h-[80vh] overflow-y-auto">
                      <DialogHeader>
                        <DialogTitle className="text-2xl text-gymbro-orange">{member.name}</DialogTitle>
                      </DialogHeader>
                      <div className="mt-4">
                        <h4 className="text-xl text-gymbro-orange mb-4">{member.title}</h4>
                        {member.bio.split('\n\n').map((paragraph, index) => (
